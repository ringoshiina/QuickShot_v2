...
const DEFAULT_AUTO_SWITCH_PARCEL = true;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const autoSwitchParcelInput = document.getElementById("auto-switch-parcel");
  ...
  chrome.storage.sync.get({
    ...
    autoSwitchParcel: DEFAULT_AUTO_SWITCH_PARCEL
  }, (items) => {
    ...
    if (autoSwitchParcelInput) {
      autoSwitchParcelInput.checked = items.autoSwitchParcel !== false;
    }
  });
  ...
  form.addEventListener("submit", (event) => {
    ...
    const autoSwitchParcel = autoSwitchParcelInput ? autoSwitchParcelInput.checked : DEFAULT_AUTO_SWITCH_PARCEL;
    ...
    chrome.storage.sync.set({
      ...
      autoSwitchParcel: autoSwitchParcel
    }, () => {
      if (chrome.runtime.lastError) {
